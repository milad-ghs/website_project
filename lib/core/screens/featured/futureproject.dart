...
import 'package:website/core/widgets/featured/sliderpicture.dart';
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(AppLocalizations.of(context)!.featured, style: TextStyle(color: const Color.fromRGBO(56, 75, 112, 1), fontSize: 12.sp)),
